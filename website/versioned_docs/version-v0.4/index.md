...
4. [Understand the execution model](architecture/engine-overview)

## Archive Notice

You are viewing archived `v0.4` docs for compatibility while migrating to `v0.5`.
For current features, switch versions from the top navbar.
